...
public class OVRGazePointer : MonoBehaviour {
    ...
    public void SetPosition(Vector3 pos, Vector3 normal)
    {
        ...
        newRot.SetLookRotation(normal, cameraRig.centerEyeAnchor.transform.up);
    ...
    void LateUpdate()
    {
        ...
        if (positionSetsThisFrame == 0)
        {
            ...
            Quaternion newRot = transform.rotation;
            newRot.SetLookRotation(cameraRig.centerEyeAnchor.transform.forward, cameraRig.centerEyeAnchor.transform.up);
            transform.rotation = newRot;
        }
